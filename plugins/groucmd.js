...
const {
  ...
  let _0x3f6faa;
  try {
    _0x3f6faa = await _0x4375b2.profilePictureUrl(_0x24f18e, "image")["catch"](() => "https://qu.ax/Pusls.jpg");
  } catch (_0x6d1bf4) {
    _0x3f6faa = "https://qu.ax/NfJZk.jpg";
  }
...
ezra({
  ...
  await _0xb269b7("*TOFAN-MD is sending this message to all groups you are in*...");
  for (let _0x398282 of _0x115598) {
    let _0x25a35f = "‼️‼️QADEER-𝐀𝐈 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓️‼️️‼️\n\n❗*message* : " + _0x1360fc + "\n\n️‼️ *Author*: " + _0x271224;
...
ezra({
  ...
  _0x298913("All pending participants have been approved to join by Tofan md.");
});
...
ezra({
  ...
  try {
    ...
    for (let _0x269fcd of _0x267c2d) {
      ...
      let _0x5838c2 = _0x269fcd.name || _0x269fcd.notify || "[QADEER] +" + _0x23a8f8;
      _0x4a6ecd += "BEGIN:VCARD\nVERSION:3.0\nFN:" + _0x5838c2 + "\nTEL;type=CELL;type=VOICE;waid=" + _0x23a8f8 + ':+' + _0x23a8f8 + "\nEND:VCARD\n";
    }
    await _0x2e5b52("A moment, *QADEER-AI* is compiling " + _0x267c2d.length + " contacts into a vcf...");
