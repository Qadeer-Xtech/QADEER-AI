...
module.exports = {
    ...
    description: 'Displays the QADEER-AI command menu with interactive buttons',
    run: async (context) => {
                        ...
                        buttons: [
                            {
                                ...
                                buttonParamsJson: JSON.stringify({
                                    ...
                                    url: 'https://github.com/Qadeer-Xtech/QADEER-AI',
                                    merchant_url: 'https://github.com/Qadeer-Xtech/QADEER-AI',
                                }),
                            },
                            {
                                name: 'single_select',
        ...
        const xhClintonPaths = [
            path.join(__dirname, 'QADEER-AI'),
            path.join(process.cwd(), 'QADEER-AI'),
            path.join(__dirname, '..', 'QADEER-AI')
        ];
