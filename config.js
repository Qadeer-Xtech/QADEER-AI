...
MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://qu.ax/yyTAH.jpg",
...
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© POWERED QADEER KHAN*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://qu.ax/CFJyk.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> Powered by *QADEER KHAN*⚡",
// add alive msg here 
