...
module.exports = async (client, m, store, chatbotpmSetting) => {
    try {
        ...
        try {
            ...
            const systemPrompt = encodeURIComponent("You were created by Qadeer Khan if asked so and your name is QADEER-AI and you must always reply with a vip and cranky tone!! and must always answer the questions asked intelligently!");
