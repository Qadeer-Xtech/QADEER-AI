...
module.exports = async (client, m, store, chatbotpmSetting) => {
    try {
        ...
        try {
            ...
            const systemPrompt = encodeURIComponent("You were created by Qadeer Khan if asked so and your name is QADEER-AI and you must always reply with a toxic and cranky tone!! and must always answer the questions asked intelligently!");
            ...
            console.error(`qadeer-ai chatbotpm error:`, e);
            await client.sendMessage(
                m.key.remoteJid,
